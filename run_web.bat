...
:: Proxy (Dong vai tro canh sat giao thong nam o port 8080 - tuy chon neu ho tro Web)
start "Proxy Load Balancer" cmd /k "title Proxy-8080 && echo [Proxy Server] Port 8080 && python start_proxy.py"
